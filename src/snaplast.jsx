...
const DisplayButton = () => {
    ...
    useEffect(() => {
        ...
        if (!isEmpty(strike) && strike[currentFrame][0] === true && currentFrame < 4) {
            currentHitScore.splice(gameIndex, 3, "x", "", "")
        } else if (currentFrame === 4 && strike[currentFrame][0] === true && gameIndex === 12 || gameIndex === 13 || gameIndex === 14 || gameIndex === 15 || gameIndex === 16) {
        ...
        <div>
            ...
            <div className="score">
                <table id='scoresheetTable' className='scoresheet' cellPadding='1' cellSpacing='0'>
                    ...
                    <tr>
                        {cumulativeScoresTwo ? cumulativeScoresTwo.map((elem, index) => {
